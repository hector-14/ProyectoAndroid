package mx.edu.tesoem.isc.p2hmrmm0125;
...
public class PrincipalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gvDatos = findViewById(R.id.gripDatos);
        ...
        gvDatos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int posicion, long l) {
                /*Se divide entre 7 porque tenemos 7 columnas y el grid interpreta todo como un array de corrido */
    ...
    public void btn_agregar(View view){
        Intent agregar = new Intent(this, mx.edu.tesoem.isc.p2hmrmm0125.agregar.class);
        startActivity(agregar);
    }
    public void btn_modificar(View view){
        if (enviar != "Selecciona una persona"){
            Intent actualizar = new Intent(this, mx.edu.tesoem.isc.p2hmrmm0125.actualizar.class);
    ...
    public void btn_eliminar(View view){
        if (enviar != "Selecciona una persona"){
            Intent eliminar = new Intent(this, mx.edu.tesoem.isc.p2hmrmm0125.eliminar.class);
